(function initMetricGlossary(root, factory) {
  ...
  const METRICS = [
    ...
    },
    {
      ...
      formula: '알약별 정확성 점수 ÷ 40 을 더해 채점된 알약 수로 나눈 뒤 100을 곱한다. 정답 40점=1.0, 부분정답 20점=0.5, 오답 0점=0.',
    ...
    },
    {
      ...
      formula: '전체 가중 정확도와 같은 방식(정답 1.0 · 부분정답 0.5 · 오답 0)을 그 모델의 응답에만 적용.',
    ...
    },
    {
      ...
      formula: '배치 100점 총점의 평균. 총점 = 알약 5개 정확성 평균(0~40) + 근거 타당성(0~25) + 환각 억제(0~20) + 명확성(0~15).',
